...
GITHUB_USER = "muhammadqodirovshahzodbek4995-prog"
GITHUB_REPO = "Telegram-bozor-bot"
GITHUB_FILE = "bozor_data.json"
    ...
    try:
        ...
        with urllib.request.urlopen(req) as resp:
            ...
            with open(DATA_FILE, "w", encoding="utf-8") as f:
                f.write(content)
            print("✅ GitHub'dan ma'lumotlar yuklandi")
    except Exception as e:
        print(f"⚠️ GitHub'dan yuklashda xato: {e}")
...
def github_save():
    try:
        ...
        body = json.dumps({"message": "auto: data updated", "content": encoded, "sha": sha}).encode("utf-8")
        put_req = urllib.request.Request(url, data=body, method="PUT", headers={
            "Authorization": f"token {GITHUB_TOKEN}",
            "Accept": "application/vnd.github.v3+json",
            "Content-Type": "application/json"
        })
        urllib.request.urlopen(put_req)
        print("✅ GitHub'ga saqlandi")
    except Exception as e:
        print(f"⚠️ GitHub'ga saqlashda xato: {e}")
...
def main():
    ...
    github_load()
    TOKEN = os.getenv("BOT_TOKEN", "8213220755:AAEko56m0rknjXcD01g6PS826IBHgQ3F_A8")
